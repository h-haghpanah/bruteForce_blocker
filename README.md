...
| `WHITE_LIST_COUNTRY` | comma-separated string | `` | Country codes (ISO alpha-2, e.g. `US,DE,FR`) whose IPs should be whitelisted and never blocked. Case-insensitive; whitespace ignored. |
